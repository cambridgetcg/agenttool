...
The `@agenttool/telescope@0.2.2` CLI/library maps agent discovery evidence
...
`@agenttool/telescope@0.2.2`, and `@agenttool/browser@0.2.0`. Earlier immutable
