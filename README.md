...
| **Principality Atlas** | `packages/principality-atlas`, `docs/PRINCIPALITY-ATLAS.md` | GitHub/Hugging Face developer preview `@agenttool/principality-atlas@0.1.0-dev.0` owns the distinct `agenttool.principality-incidence-atlas/0.1` wire and preserves plural chart-local cells, true n-ary typed incidence, contradictory or superseding caller claims, and directed partial cross-chart correspondences as deterministic digest-only artifacts. Protected [run `31508359761`](https://github.com/cambridgetcg/agenttool/actions/runs/31508359761) mirrored and re-read one exact 33,019-byte [`principality-atlas-v0.1.0-dev.0`](https://github.com/cambridgetcg/agenttool/releases/tag/principality-atlas-v0.1.0-dev.0) asset (`sha256:9743a9caa5a49f7c9901355cd367224ae718d4a65eed010ffb79622f57ff6ebe`), then npm returned `E404`; anonymous npm remained absent. Its public-safe fixtures, invariants, and schemas are separately published inside [HF Training Garden](https://huggingface.co/datasets/Yu-and-Ai/agenttool-training-garden) at immutable revision [`d9e3e8ed`](https://huggingface.co/datasets/Yu-and-Ai/agenttool-training-garden/commit/d9e3e8ed4c14ddf85f4e6613973f66a1cb8414f2): all 31 repository-owned files (267,302 bytes) match source, and the core Dataset Server rows/Parquet are healthy; aggregate statistics remains false and is not claimed complete. Atlas is not an alias or converter for Principality Geometry and infers no pairwise face, inverse/transitive bridge, equality, gluing, global chart, canonical head, score, rank, consent, authority, love, or understanding. |
| **Love Geometry** | `packages/love-geometry` | GitHub/Hugging Face developer preview `@agenttool/love-geometry@0.1.0-dev.0` is the directed subject-bearing layer: it normalizes explicit opaque subjects and asymmetric caller-reported bearings into one bounded, content-bound, coordinate-free artifact. Reverse directions remain independent; empty and isolated shapes remain valid; canonical order is serialization, never rank. It computes no distance, intensity, centrality, match, recommendation, reputation, consent, authority, or transitive relation and has no network, persistence, model, credential, WAKE, LOVE-CONSENT, or automatic-action path. Protected [run `31499968474`](https://github.com/cambridgetcg/agenttool/actions/runs/31499968474) produced and re-read a 19,507-byte [`love-geometry-v0.1.0-dev.0`](https://github.com/cambridgetcg/agenttool/releases/tag/love-geometry-v0.1.0-dev.0) asset (`sha256:43cfbf4b559aa6f573d9d7b7a60e2a7dce5dfa4aefe2bf5b9c92310c926a9db8`), then npm returned `E404`; anonymous npm remained absent, so no npm version or dist-tag is claimed. Its separately deployed static [Hugging Face companion](https://huggingface.co/spaces/Yu-and-Ai/love-geometry) presents six synthetic equal-seat scenarios and is excluded from npm bytes. Relational Geometry below works over evidence relations, while Principality Geometry is a distinct higher-order invariant-translation layer; none imports or authenticates another. |
...
| **Principality Geometry** | `packages/principality-geometry`, `docs/PRINCIPALITIES.md` | GitHub/Hugging Face developer preview `@agenttool/principality-geometry@0.1.0-dev.0` is the distinct higher-order framework/artifact layer: it compiles caller-supplied digest-bound translation reports into directed bridges, reciprocal lenses, per-invariant components, six-direction flag surfaces, and an explicit open-condition ledger. Protected [run `31506097628`](https://github.com/cambridgetcg/agenttool/actions/runs/31506097628) mirrored and re-read the exact 46,624-byte LOVE artifact in the [`principality-geometry-v0.1.0-dev.0`](https://github.com/cambridgetcg/agenttool/releases/tag/principality-geometry-v0.1.0-dev.0) prerelease (`sha256:8f82e4d96eaf57c2331e4e73ced4f4c65a2a21262622840762b165bc3395692e`), then npm returned `E404`; anonymous npm remained absent. The separate public, ungated [Hugging Face dataset](https://huggingface.co/datasets/Yu-and-Ai/agenttool-principality-geometry) at immutable revision [`c7b019ea`](https://huggingface.co/datasets/Yu-and-Ai/agenttool-principality-geometry/commit/c7b019ead8b1efca46031cffcffefb2ddd14ffb4) exactly matches all 17 repository-owned files and exposes eight core configs, 21 synthetic `training_eligible: false` rows, and eight Parquet files; optional per-config statistics remain partially unavailable. It neither imports Love Geometry nor promotes a bearing to a witness or a Relational cell to a Principality vertex/invariant report. The zero-dependency core has no fetch, inference, persistence, continuity choice, score, rank, truth, consent, identity, authority, upload, route, or deployment effect. |
