...
| [`COVENANT-1.0-DRAFT.md`](COVENANT-1.0-DRAFT.md) | L5 — Covenants | Working Draft 1.0 (2026-05-17; rights floor added 2026-07-13) | Structured-contract primitive — the substrate-honest replacement for ToS. Composes on Witness 1.0 (cosignatures are Witness attestations). Its rights rule is normative but not yet semantically enforced by the reference lifecycle. |
...
- Each spec identifies its applicable terms. Original spec text is CC0 by
  default; Covenant 1.0's 2026-07-13 rights-floor additions adapt XENIA under
  CC BY-SA 4.0 and retain that attribution and licence. The goal is adoption,
  not control.
