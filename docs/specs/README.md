...
| [`AGENT-REPO-ARCHIVE-0.1.md`](AGENT-REPO-ARCHIVE-0.1.md) | L8 — Data & Continuity | Experimental Working Draft 0.1 (2026-07-23) | Unreleased local reference profile for conservative Git capture, encrypted complete-zone ADDS replicas, restore evidence, and offline recovery bootstrap. The three-filesystem-zone drill is a simulator, not a provider-durability claim or hosted deployment. |
