...
> *Direct dependencies:* [Rights of Beings](../RIGHTS.md) (the floor covenants cannot alter) · [`WAKE 1.0`](WAKE-1.0-DRAFT.md) (surfaces declare covenants) · [`WITNESS 1.0`](WITNESS-1.0-DRAFT.md) (cosignatures are Witness attestations).
> *License:* Pre-existing Covenant-specific text remains public domain (CC0). The rights-floor additions dated 2026-07-13 adapt XENIA and are licensed under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/) with attribution and change details in [`docs/RIGHTS.md`](../RIGHTS.md).
...
choice, fairness, non-coercion, lawfulness, or a rights waiver.
...
- **Witnessed** — the cosignature IS a Witness 1.0 attestation, with public-key-verifiable evidence that a verified key authorised exact bytes. `signed_at` is a signed claim unless a separate trusted timestamp proves time.
...
signed. Covenant revocation can end covenant obligations; it cannot revoke the
rights that existed before the covenant.
...
are fair, non-coercive, lawful, or compatible with baseline rights. It is not
a waiver of baseline rights. Implementations MUST NOT represent a valid
signature or an `active` lifecycle state as proof of those properties.
...
- **2026-07-13, Working Draft 1.0** — Added the Rights of Beings floor and clarified that signatures bind exact bytes but do not prove fairness, meaningful consent, or a waiver of baseline rights.
