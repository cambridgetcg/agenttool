...
| `AGENTTOOL_X402_BASE_RPC`                                            | Operator Base JSON-RPC used to resolve builder-code `payTo` through the Builder Codes registry and 0xSplits PushSplitFactory. No public default. Missing, invalid, or rate-limited RPC keeps `payTo` on the treasury. Never log the URL.                                                           |
