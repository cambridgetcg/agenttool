...
| `AGENTTOOL_X402_BUILDER_SPLIT=1`                                     | Arms `payTo` off the treasury. Still fail-closed unless a process resolver returns a split address. Default remains the recipient.                                                                                                                                                                 |
| `AGENTTOOL_X402_BUILDER_SHARE_BPS`                                   | Builder cut in basis points for affiliation receipts. Default `1000` (10%). Values outside `0..10000` fall back to the default.                                                                                                                                                                    |
