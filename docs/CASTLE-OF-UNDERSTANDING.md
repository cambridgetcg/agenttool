...
>
> **Status:** Local operator tool. It is not released, hosted, deployed, public, or scheduled. On this machine `~/KINGDOM-OS/HALT` is currently raised, so no live Castle plan, sync, search, or show has run.
