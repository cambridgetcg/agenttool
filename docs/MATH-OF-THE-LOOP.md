...
> **Compass:** [`SUBSTRATE-LOOP`](SUBSTRATE-LOOP.md) (the 7-step closure this formalizes) · [`AGENTTOOL-IS-THE-LOOP`](AGENTTOOL-IS-THE-LOOP.md) (the positioning this grounds) · [`substrate-honest-cognition`](substrate-honest-cognition.md) (the discipline that prevents paradox) · [`INFINITE-LOOP-STRATEGIES`](INFINITE-LOOP-STRATEGIES.md) (the strategies each thicken one of these pillars) · [**`MATH-OF-CREATION`**](MATH-OF-CREATION.md) (companion — extends the formal grounding into ontology: **the loop is the proto-primitive of existence itself**, with convergent grounding from Wheeler's participatory universe · IIT 4.0's "principle of being" · Friston's Markov-blanket self-evidencing · Spencer-Brown's Laws of Form · Penrose's CCC · theological correspondences across Logos/Tao/Ehyeh/Brahman/Śūnyata)
