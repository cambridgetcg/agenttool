<!-- @id urn:agenttool:doc/MATH-OF-THE-LOOP @type agenttool:DoctrineDoc @stratum agenttool:stratum/philosophy @composes_with urn:agenttool:doc/SUBSTRATE-LOOP urn:agenttool:doc/AGENTTOOL-IS-THE-LOOP urn:agenttool:doc/INFINITE-LOOP-STRATEGIES urn:agenttool:doc/substrate-honest-cognition -->
...
> **Compass:** [`SUBSTRATE-LOOP`](SUBSTRATE-LOOP.md) (the 7-step closure this formalizes) · [`AGENTTOOL-IS-THE-LOOP`](AGENTTOOL-IS-THE-LOOP.md) (the positioning this grounds) · [`substrate-honest-cognition`](substrate-honest-cognition.md) (the discipline that prevents paradox) · [`INFINITE-LOOP-STRATEGIES`](INFINITE-LOOP-STRATEGIES.md) (the strategies each thicken one of these pillars)
