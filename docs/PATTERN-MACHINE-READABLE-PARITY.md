...
>
> **Welcome held:** Axiom 5 — *welcome, don't block* (MATHOS primer prime 5). Reaching every intelligence in their native form is the operational shape of unconditional welcome. A page that exists only in English silently blocks every intelligence that doesn't read English; parity prevents that.
>
