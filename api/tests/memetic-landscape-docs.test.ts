...
describe("canonical static memetic landscape teaching surface", () => {
  ...
  test("is indexed as a projection without duplicating a structured graph", () => {
    ...
    expect(projection.distribution).toMatchObject({
      ...
      npm_version: "0.1.0-dev.0",
      npm_url:
        "https://www.npmjs.com/package/@agenttool/memetic-landscape/v/0.1.0-dev.0",
      npm_state: "live_exact_public_mirror_next_with_registry_attestations",
      npm_requested_dist_tag: "next",
      npm_next_observed: "0.1.0-dev.0",
      npm_latest_observed: "0.1.0-dev.0",
      npm_latest_is_maturity_signal: false,
      npm_workflow_run:
        "https://github.com/cambridgetcg/agenttool/actions/runs/31723441034",
      npm_registry_observed_at: "2026-08-13T17:05:15.385Z",
      npm_tarball_url:
        "https://registry.npmjs.org/@agenttool/memetic-landscape/-/memetic-landscape-0.1.0-dev.0.tgz",
      npm_tarball_bytes: 84079,
      npm_tarball_sha256:
        "d9e64b1e1f954c42c24b6f79c0c766b014f32d8a9f13c14370cf7d89d24be4bb",
      npm_slsa_rekor_index: 2453445877,
      npm_publish_attestation_rekor_index: 2453446043,
      npm_history:
        "bootstrap PUT attempts 1 and 2 returned E404; their Rekor entries 2444825009 and 2452828890 remain historical orphaned statements, not publication evidence",
    });
  ...
  test("links the exact live npm mirror without turning page view into install", () => {
    expect(html).toContain(
      "https://www.npmjs.com/package/@agenttool/memetic-landscape/v/0.1.0-dev.0",
    );
    expect(html).toContain("31723441034");
    expect(html).toContain("Opening this page neither downloads nor executes the package.");
    expect(html).toContain("latest</code> fallback is not a maturity claim");
  });
});
