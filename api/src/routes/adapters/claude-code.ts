...
- Open-protocol portability (Codex, Cursor, and other CLIs can fetch the same
  wake URL directly; they do not have mounted first-class adapter routes)
- Identity expression that travels (this file is the local anchor; the
  effective register/walls/subagents/wake_text surface in the wake)
