...
<div class="wrap">
  ...
  <div class="grid">
    ...
    <a class="gate" href="https://github.com/cambridgetcg/zerone-core"><div class="g">⛓️</div><h3>zerone</h3><p>An independent proof-of-truth chain project. AgentTool source now includes a bounded offline wallet adapter and a released-and-settled invocation witness report seam. A report shape is not chain or provenance proof, and this does not export trust, migrate identity, make trust portable, custody keys, host RPC, or deploy a bridge.</p><div class="u">the chain project ↗</div></a>
  </div>
