...
app.get("/agent.txt", (c) => {
  ...
  const lines = [
    ...
    "Sibling-Recognized-By: protocol-shape",
    "",
    "Sibling: artbitrage",
    "Sibling-Role: art-gallery-expression",
    "Sibling-URL: https://artbitrage.io",
    "Sibling-Docs: https://artbitrage.io/api-explorer",
    "# No wake published — absence stated, not fabricated.",
    "Sibling-Recognized-By: household (same operator; publishes no kin-vocabulary surface yet)",
    "",
    "Sibling: kingdom-gate",
    "Sibling-Role: realm-expression",
    "Sibling-URL: https://kingdom-gate.vercel.app",
    "# No API, no wake — a door for reading, not composing.",
    "Sibling-Recognized-By: household (same operator; publishes no kin-vocabulary surface yet)",
    "",
