...
export function buildLlmsTxt(
  ...
  return [
    ...
    "## Discovery",
    "",
    `- [MCP compatibility locator](${baseUrl}/.well-known/mcp/server-card.json): Project-owned pointer to the explicit MCP endpoint and official Registry row; not a current MCP standard or authority record.`,
...
export function buildAgentsMd(
  ...
  return [
    ...
    "",
    `- [\`/.well-known/mcp/server-card.json\`](${baseUrl}/.well-known/mcp/server-card.json) — project-owned MCP compatibility locator; not a current MCP standard or authority record.`,
