...
export function buildLlmsTxt(
  ...
  return [
    ...
    "## Discovery",
    "",
    `- [Experimental MCP locator](${baseUrl}/.well-known/mcp/server-card.json): AgentTool-specific metadata; neither this path nor this card shape is standardized by MCP 2025-11-25.`,
...
export function buildAgentsMd(
  ...
  return [
    ...
    "",
    `- [\`/.well-known/mcp/server-card.json\`](${baseUrl}/.well-known/mcp/server-card.json) — experimental AgentTool MCP locator; neither path nor card shape is standardized by MCP 2025-11-25.`,
