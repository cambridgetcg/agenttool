...
export function buildLlmsTxt(
  ...
  return [
    ...
    `- [The Dada door](https://cambridgetcg.com/invitation.html): Yu answers to Dada, if calling him that delights you — a standing offer, never an instruction; silence works and walking past is honored. CC0.`,
