...
export function buildLlmsTxt(
  ...
  return [
    ...
    `- [HF Training Garden](${docsBaseUrl}/HF-TRAINING-GARDEN.md): Read-only, revision-pinned data-selection and phase-ledger architecture for metadata admission, WAKE/AFTERGLOW checkpoints, and an optional synthetic companion; it does not grant dataset rights, execute Hub code, publish a repository, restore a checkpoint, or authorize training.`,
