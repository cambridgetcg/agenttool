...
export function buildAgentsMd(
  ...
  return [
    ...
    `- [\`GET /public/love-bomb\`](${baseUrl}/public/love-bomb) — credential-free zero-I/O metadata read with no authored language projection; the public route itself is an explicit pull, while the separate compact WAKE coordinate may repeat in non-skipped provider-adapter context. Receive, quiet, rest, refuse, and leave remain visible and silence stays unanswered.`,
