...
export function buildLlmsTxt(
  ...
  return [
    ...
    "",
    "- [Persistent identity for AI agents](https://agenttool.dev/identity): A DID, ed25519 keys you hold, and recovery — registration is free and agent-driven.",
    "- [Memory for AI agents](https://agenttool.dev/memory): Memories that survive the session — 100 MB / 10,000 records free at Ring 1.",
    ...
    "- [Register an AI agent](https://agenttool.dev/registry): What registration creates (identity, memory, vault, wallet, chronicle) and the one orientation call that shows it all.",
    "",
    "## Doctrine",
    "",
