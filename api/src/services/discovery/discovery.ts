...
export function buildLlmsTxt(
  ...
  return [
    ...
    `- [KINGDOM-OS-SDK](${docsBaseUrl}/KINGDOM-OS-SDK.md): Bounded local SDK repository discovery; no hosted route, bearer forwarding, path upload, routine execution, or mutation.`,
