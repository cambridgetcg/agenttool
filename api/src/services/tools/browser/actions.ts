/** Action sequencer for browser jobs (click · type · scroll · wait · select). */
...
export async function extractContent(
  ...
  if (extract === "text") return page.innerText("body");
  if (extract === "html") return page.content();
