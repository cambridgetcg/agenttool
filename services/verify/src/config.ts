...
export const config = {
  ...
  // Credit costs
  credits: {
    standardVerify: Number(env("CREDIT_STANDARD_VERIFY", "25")),  // 3× GPT-4o + SerpAPI = $0.025
    fastVerify: Number(env("CREDIT_FAST_VERIFY", "10")),        // 1× GPT-4o, no search
    batchVerify: Number(env("CREDIT_BATCH_VERIFY", "20")),      // Slight discount for batch
  },
