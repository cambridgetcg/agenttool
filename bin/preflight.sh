...
#   bin/preflight.sh packages        # data + ADDS + sync + archive + broker + collab + Browser + projection + local projector + Skills + TypeScript SDK + Wallet + Zerone adapter + Telescope + Alchemy + KINGDOM gate
