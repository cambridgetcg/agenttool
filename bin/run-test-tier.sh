...
readonly TEST_SUPPORT_FILES=(
  ...
  tests/fixtures/launch-core-journey.ts
...
case "$MODE" in
  ...
  database)
    ...
    unset AGENTTOOL_REGISTRATION_RATE_LIMIT_ENABLED AGENTTOOL_REGISTRATION_RATE_LIMIT_REDIS_URL AGENTTOOL_RATE_LIMIT_TIMEOUT_MS
    unset AGENTTOOL_LAUNCH_CORE_TEST_DATABASE_URL AGENTTOOL_LAUNCH_CORE_CUSTODY_FILE AGENTTOOL_LAUNCH_CORE_EVIDENCE_FILE
