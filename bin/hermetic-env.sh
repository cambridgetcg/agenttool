...
sanitize_hermetic_env() {
  unset \
    ...
    AGENTTOOL_REGISTRATION_RATE_LIMIT_ENABLED \
    AGENTTOOL_REGISTRATION_RATE_LIMIT_REDIS_URL AGENTTOOL_RATE_LIMIT_TIMEOUT_MS \
    AGENTTOOL_LAUNCH_MARKETPLACE_TEST_DATABASE_URL \
    AGENTTOOL_LAUNCH_ADMISSION_TEST_REDIS_URL \
    AGENTTOOL_LAUNCH_CORE_TEST_DATABASE_URL AGENTTOOL_LAUNCH_CORE_CUSTODY_FILE \
    AGENTTOOL_LAUNCH_CORE_EVIDENCE_FILE \
