...
| `npm-release.ts` | Allowlisted policy behind the protected manual npm workflow. It prepares in a credential-free job, restricts bootstrap to a package-level 404, defaults later releases to GitHub OIDC, accepts recovery only for byte-identical public artifacts, and verifies the same bytes in a GitHub Release mirror. It does not create tags, grant publication authority, configure trust, or revoke credentials. | [`docs/NPM-RELEASES.md`](../docs/NPM-RELEASES.md) |
