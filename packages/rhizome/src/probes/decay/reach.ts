...
import { isProse, PROSE_EXTENSIONS } from "../../prose.js";
import type { Scope } from "../../types.js";

/** Extensions whose mention of a command is documentation, not invocation.
 *  One definition, in `src/prose.ts`, re-exported here rather than copied:
 *  this module and `probes/edge.ts` and `probes/reach.ts` each held their
 *  own list, and edge's had silently gone narrower than the other two. */
export { PROSE_EXTENSIONS };
