...
const expected = [
  ...
  "package.json",
  "schema/agenttool-public-surface-adoption-v0.1.schema.json",
  "schema/agenttool-public-surface-withdrawal-v0.1.schema.json",
...
if (JSON.stringify(files) !== JSON.stringify(expected)) {
  ...
  throw new Error(
    `packed public-surface-recognition inventory differs; missing=${JSON.stringify(missing)} unexpected=${JSON.stringify(unexpected)}`,
  );
}
