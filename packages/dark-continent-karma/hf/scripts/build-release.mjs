...
function treasureRecord(treasure) {
  ...
  return {
    ...
    graph_projection: {
      state: "proposed",
      node_kinds: ["DatasetRelease", "TrainingPhase", "RiskGate"],
      allowed_relations: ["derived_from", "used_in_phase", "observed_at", "measures", "validated_by", "conflicts_with", "requires_review"],
