...
```
src/agenttool/
  __init__.py            — Public surface + __version__ ("0.21.0")
...
- `src/agenttool/__init__.py` — Public API surface (`__version__ = "0.21.0"`)
