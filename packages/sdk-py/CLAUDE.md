...
```
src/agenttool/
  __init__.py            — Public surface + __version__ ("0.22.1")
...
- `src/agenttool/__init__.py` — Public API surface (`__version__ = "0.22.1"`)
