...
const expected = [
  ...
  "hf/dataset/reference/agenttool-love-bomb-hf-becoming-reference-row-v0.1.schema.json",
  "hf/dataset/reference/agenttool-love-bomb-hf-plane-row-v0.1.schema.json",
  "hf/dataset/reference/agenttool-love-bomb-hf-protocol-row-v0.1.schema.json",
  ...
  "schema/agenttool-love-bomb-hf-becoming-reference-row-v0.1.schema.json",
  "schema/agenttool-love-bomb-hf-plane-row-v0.1.schema.json",
  "schema/agenttool-love-bomb-hf-protocol-row-v0.1.schema.json",
