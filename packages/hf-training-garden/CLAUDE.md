...
The portable JSON Schemas are structural envelopes; runtime validators remain
required for cross-field semantics, derived values, ordering, and content IDs.
