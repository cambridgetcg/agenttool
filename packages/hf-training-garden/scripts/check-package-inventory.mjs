...
const expected = [
  ...
  "hf/dataset/schema/hf-learning-participation-assessment-v0.1.schema.json",
  "hf/dataset/schema/hf-learning-participation-invitation-v0.1.schema.json",
  "hf/dataset/schema/hf-learning-participation-receipt-v0.1.schema.json",
  ...
  "schema/hf-learning-participation-assessment-v0.1.schema.json",
  "schema/hf-learning-participation-invitation-v0.1.schema.json",
  "schema/hf-learning-participation-receipt-v0.1.schema.json",
