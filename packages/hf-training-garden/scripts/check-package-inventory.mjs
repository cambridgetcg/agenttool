...
const expected = [
  ...
  "hf/dataset/schema/agenttool-principality-atlas-fixture-v0.1.schema.json",
  "hf/dataset/schema/agenttool-principality-atlas-invariant-v0.1.schema.json",
  "hf/dataset/schema/agenttool-principality-atlas-v0.1.schema.json",
  "package.json",
