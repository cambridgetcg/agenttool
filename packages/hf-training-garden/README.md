...
contains policy tables, phase guides, the current closed admission,
participation, checkpoint, and tending schemas plus exact local binding shapes and the exact attributed
Apache AFTERGLOW dependency schema, and hash manifests only. Local
